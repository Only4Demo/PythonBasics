...
#columns3 = "666666666777777777788888888889999999999000000000011111111112"
columns = 9*"0"+10*"1"+10*"2"+10*"3"+10*"4"+10*"5"+"6"
columns2 = 6*"1234567890"
columns3 = 9*"6"+10*"7"+10*"8"+10*"9"+10*"0"+10*"1"+"2"
...
print(teststring)
print(rulerbar + rulerbar + "\n" + columns + columns + "\n" + columns2 + columns3)

print ("\nDieser beinhaltet folgende Anzahl pro Sonderzeichen:\n")
